...
(function() {
  ...
  Spine = require('spine');
  Employee = (function() {
    __extends(Employee, Spine.Model);
    function Employee() {
      Employee.__super__.constructor.apply(this, arguments);
    }
    Employee.configure('Employee', 'firstName', 'lastName', 'startDate', 'email');
    return Employee;
  })();
...
(function() {
  ...
  $ = jQuery;
  JuggernautHandler = (function() {
    __extends(JuggernautHandler, Spine.Module);
    JuggernautHandler.include(Spine.Log);
    JuggernautHandler.prototype.logPrefix = '(Juggernaut)';
    function JuggernautHandler(options) {
      var _base, _base2, _base3;
      this.options = options != null ? options : {};
      this.processWithoutAjax = __bind(this.processWithoutAjax, this);
      this.process = __bind(this.process, this);
      (_base = this.options).host || (_base.host = $('meta[name=juggernaut-host]').attr('content'));
      (_base2 = this.options).port || (_base2.port = $('meta[name=juggernaut-port]').attr('content'));
      (_base3 = this.options).transports || (_base3.transports = ['xhr-multipart', 'xhr-polling', 'jsonp-polling']);
      this.jug = new Juggernaut(this.options);
      this.jug.on('connect', __bind(function() {
        return this.log('connected');
      }, this));
      this.jug.on('disconnect', __bind(function() {
        return this.log('disconnected');
      }, this));
      this.jug.on('reconnect', __bind(function() {
        return this.log('reconnecting');
      }, this));
      $.ajaxSetup({
        beforeSend: __bind(function(xhr) {
          return xhr.setRequestHeader('X-Session-ID', this.jug.sessionID);
        }, this)
      });
      this.jug.subscribe('/observer', this.processWithoutAjax);
    }
    JuggernautHandler.prototype.process = function(msg) {
      var klass;
    ...
    JuggernautHandler.prototype.processWithoutAjax = function() {
      var args;
      args = arguments;
      return Spine.Ajax.disable(__bind(function() {
        return this.process.apply(this, args);
      }, this));
    };
    return JuggernautHandler;
  })();
  $(function() {
    return new JuggernautHandler;
  });
}).call(this);
(function() {
  var Page;
  ...
  Page = (function() {
    __extends(Page, Spine.Model);
    function Page() {
      Page.__super__.constructor.apply(this, arguments);
    }
    Page.configure("Page", "name", "slug", "body");
...
(function() {
  ...
  User = (function() {
    ...
    User.configure('User', 'username', 'password');
    return User;
  })();
  module.exports = User;
}).call(this);
(function() {
  var EditEmployee, Employee, EmployeesController, EmployeesOverview, EmployeesViewStack, List, Spine;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  */
  EmployeesController = (function() {
    __extends(EmployeesController, Spine.Controller);
    EmployeesController.prototype.className = 'employees';
    function EmployeesController() {
      EmployeesController.__super__.constructor.apply(this, arguments);
      this.employeeViewStack = new EmployeesViewStack();
      this.append(this.employeeViewStack);
      /*
            routes using by employeesViewStack
          */
      this.routes({
        '/employees/:id/add': function(params) {
          var data;
          data = {
            id: params.id,
            add: true
          };
          return this.employeeViewStack.addEmployee.active(data);
        },
        '/employees/:id/edit': function(params) {
          ...
          return this.employeeViewStack.editEmployee.active(data);
        }
      });
      Spine.bind('EmployeeEvent:DELETE', this.proxy(this.confirmDelete));
    }
    /*
      ...
      */
    EmployeesController.prototype.active = function(params) {
      EmployeesController.__super__.active.call(this, params);
      return this.employeeViewStack.overview.active();
    };
    EmployeesController.prototype.confirmDelete = function(item) {
      if (confirm("Are you sure you want to delete " + item.firstName + " " + item.lastName + "?")) {
        return this["delete"](item);
      }
    };
    EmployeesController.prototype["delete"] = function(item) {
      item.destroy();
  ...
  */
  EmployeesOverview = (function() {
    __extends(EmployeesOverview, Spine.Controller);
    EmployeesOverview.prototype.className = 'employees-overview';
    EmployeesOverview.prototype.elements = {
      '#employee-list': 'items'
    };
    EmployeesOverview.prototype.events = {
      'click #bAdd': 'add',
      'click #bEdit': 'edit',
    ...
    function EmployeesOverview() {
      ...
      this.change = __bind(this.change, this);      EmployeesOverview.__super__.constructor.apply(this, arguments);
      this.mockEmployees();
      this.html(require('views/employees_overview')());
      this.list = new List({
        el: this.items,
      ...
      Employee.bind('refresh change', this.render);
    }
    EmployeesOverview.prototype.change = function(item) {
      return this.item = item;
    };
    EmployeesOverview.prototype.render = function(params) {
      var employees;
      ...
      return this.list.render(employees);
    };
    EmployeesOverview.prototype.edit = function(event) {
      if (this.item != null) {
        return this.navigate('/employees', this.item.id, 'edit');
      }
    };
    EmployeesOverview.prototype.add = function(event) {
      var item;
      item = Employee.create();
      item.save();
      return this.navigate('/employees', item.id, 'add');
    };
    EmployeesOverview.prototype["delete"] = function() {
      if (this.item != null) {
        return Spine.trigger('EmployeeEvent:DELETE', this.item);
      }
    };
    EmployeesOverview.prototype.mockEmployees = function() {
      Employee.create({
        firstName: 'Sue',
        lastName: 'Hove',
  ...
  */
  EditEmployee = (function() {
    __extends(EditEmployee, Spine.Controller);
    EditEmployee.prototype.className = 'employee-edit';
    EditEmployee.prototype.elements = {
      'form': 'form'
    };
    EditEmployee.prototype.events = {
      'submit form': 'save',
    ...
    function EditEmployee() {
      this.render = __bind(this.render, this);      EditEmployee.__super__.constructor.apply(this, arguments);
      this.active(this.render);
    }
    EditEmployee.prototype.render = function(params) {
      var data;
      this.item = Employee.find(params.id);
      data = {
        employee: this.item,
        add: params.add,
        edit: params.edit
      };
      return this.html(require('views/employee_edit_view')(data));
    };
    EditEmployee.prototype["delete"] = function() {
      return Spine.trigger('EmployeeEvent:DELETE', this.item);
    };
    EditEmployee.prototype.cancel = function(event) {
      this.item.destroy();
      return this.back();
    };
    EditEmployee.prototype.back = function() {
      return this.navigate('/employees');
    };
    EditEmployee.prototype.save = function(event) {
      event.preventDefault();
  ...
  */
  EmployeesViewStack = (function() {
    __extends(EmployeesViewStack, Spine.Stack);
    function EmployeesViewStack() {
      EmployeesViewStack.__super__.constructor.apply(this, arguments);
    }
    EmployeesViewStack.prototype.className = 'stack';
    EmployeesViewStack.prototype.controllers = {
      overview: EmployeesOverview,
      editEmployee: EditEmployee,
      addEmployee: EditEmployee
    };
    EmployeesViewStack.prototype["default"] = 'overview';
    return EmployeesViewStack;
  })();
}).call(this);
(function() {
  var $, HeaderController, Spine, User;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  */
  HeaderController = (function() {
    __extends(HeaderController, Spine.Controller);
    HeaderController.prototype.tag = 'header';
    HeaderController.prototype.events = {
    ...
    HeaderController.prototype.render = function() {
      return this.html(require('views/header_view')());
    };
    HeaderController.prototype.activate = function() {
      var user;
      user = User.first();
      $('#greetings').text('Hello ' + user.username + "!");
      return $('header div').css({
        display: 'block'
      });
    };
    HeaderController.prototype.deactivate = function() {
      $('#greetings').text('');
      return $('header div').css({
        display: 'none'
      });
...
(function() {
  var $, LoginController, Spine, User;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  */
  LoginController = (function() {
    __extends(LoginController, Spine.Controller);
    LoginController.prototype.className = 'login';
    ...
    LoginController.prototype.render = function() {
      return this.html(require('views/login_view'));
    };
    LoginController.prototype.login = function(event) {
      var item;
      event.preventDefault();
      item = User.create();
      item.fromForm(this.form).save();
      return this.navigate('/start');
    };
...
(function() {
  var $, EmployeesController, HeaderController, LoginController, MainController, MainViewStack, Spine, StartController, User;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  */
  MainController = (function() {
    __extends(MainController, Spine.Controller);
    MainController.prototype.className = 'main-view';
    function MainController() {
      var footer, header, mainViewStack;
      ...
      this.append(header, mainViewStack, footer);
    }
  ...
  */
  MainViewStack = (function() {
    __extends(MainViewStack, Spine.Stack);
    function MainViewStack() {
      MainViewStack.__super__.constructor.apply(this, arguments);
    }
    MainViewStack.prototype.className = 'main-view-content stack';
    MainViewStack.prototype.controllers = {
      login: LoginController,
      start: StartController,
      employees: EmployeesController
    };
    MainViewStack.prototype["default"] = 'login';
    return MainViewStack;
  })();
}).call(this);
(function() {
  var $, Pages, PagesEdit, PagesItem, PagesList;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  $ = jQuery;
  PagesEdit = (function() {
    __extends(PagesEdit, Spine.Controller);
    PagesEdit.prototype.events = {
      'click .back': 'back',
      'submit form': 'update'
    };
    function PagesEdit() {
      this.render = __bind(this.render, this);      PagesEdit.__super__.constructor.apply(this, arguments);
      this.active(function(params) {
        return this.change(Page.find(params.id));
      });
    }
    PagesEdit.prototype.render = function() {
      return this.html($.tmpl('app/views/pages/edit', this.item));
    };
    PagesEdit.prototype.change = function(item) {
      this.item = item;
      return this.render();
    };
    PagesEdit.prototype.update = function(e) {
      e.preventDefault();
      this.item.updateAttributes($(e.target).serializeForm());
      return this.back();
    };
    PagesEdit.prototype.back = function() {
      return this.navigate('/pages', this.item.id);
    };
    return PagesEdit;
  })();
  PagesItem = (function() {
    __extends(PagesItem, Spine.Controller);
    PagesItem.prototype.events = {
      'click .back': 'back',
      'click .edit': 'edit',
      'click .destroy': 'destroyItem'
    };
    function PagesItem() {
      this.render = __bind(this.render, this);      PagesItem.__super__.constructor.apply(this, arguments);
      Page.bind('change', __bind(function(item) {
    ...
    PagesItem.prototype.render = function() {
      return this.html($.tmpl('app/views/pages/show', this.item));
    };
    PagesItem.prototype.change = function(item) {
      this.item = item;
      return this.render();
    };
    PagesItem.prototype.destroyItem = function() {
      this.item.destroy();
      return this.back();
    };
    PagesItem.prototype.edit = function() {
      return this.navigate('/pages', this.item.id, 'edit');
    };
    PagesItem.prototype.back = function() {
      return this.navigate('/pages');
    };
    return PagesItem;
  })();
  PagesList = (function() {
    __extends(PagesList, Spine.Controller);
    PagesList.prototype.className = 'list';
    PagesList.prototype.elements = {
      '.items': 'items'
    };
    PagesList.prototype.events = {
      'click .item': 'show',
      'click .create': 'create'
    };
    function PagesList() {
      this.render = __bind(this.render, this);      PagesList.__super__.constructor.apply(this, arguments);
      this.html($.tmpl('app/views/pages/list'));
      Page.bind('refresh change', this.render);
    }
    PagesList.prototype.render = function() {
      var items;
      items = Page.all();
      return this.items.html($.tmpl('app/views/pages/item', items));
    };
    PagesList.prototype.show = function(e) {
      var item;
      item = $(e.target).item();
      return this.navigate('/pages', item.id);
    };
    PagesList.prototype.create = function(e) {
      var item;
      item = Page.create({
        name: 'Dummy page'
      });
      return this.navigate('/pages', item.id, 'edit');
    };
    return PagesList;
  })();
  Pages = (function() {
    __extends(Pages, Spine.Controller);
    function Pages() {
      Pages.__super__.constructor.apply(this, arguments);
      this.list = new PagesList;
      this.edit = new PagesEdit;
      this.item = new PagesItem;
      new Spine.Manager(this.list, this.edit, this.item);
      this.append(this.list, this.edit, this.item);
      this.routes({
        '/pages/:id/edit': function(params) {
          return this.edit.active(params);
        },
        '/pages/:id': function(params) {
          return this.item.active(params);
        },
        '/pages': function(params) {
          return this.list.active(params);
        }
      });
      this.navigate('/pages');
      Page.bind('refresh', function() {
...
(function() {
  var EditEmployee, Employee, EmployeesOverview, EmployeesViewStack, List, SettingsController, Spine;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  */
  SettingsController = (function() {
    __extends(SettingsController, Spine.Controller);
    SettingsController.prototype.className = 'employees';
    function SettingsController() {
      ...
      /*
          ...
          */
      this.routes({
        '/settings/:id/add': function(params) {
          var data;
          data = {
            id: params.id,
            add: true
        ...
        '/settings/:id/edit': function(params) {
          var data;
          data = {
            id: params.id,
            edit: true
    ...
    /*
        ...
        which is already in MainController defined before
      */
    SettingsController.prototype.active = function(params) {
      SettingsController.__super__.active.call(this, params);
      return this.employeeViewStack.overview.active();
    };
    SettingsController.prototype.confirmDelete = function(item) {
      if (confirm("Are you sure you want to delete " + item.firstName + " " + item.lastName + "?")) {
        return this["delete"](item);
      }
    };
    SettingsController.prototype["delete"] = function(item) {
      item.destroy();
      return this.navigate('/employees');
    };
...
(function() {
  var List, Spine, StartController;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  */
  StartController = (function() {
    __extends(StartController, Spine.Controller);
    StartController.prototype.className = 'start';
    function StartController() {
      StartController.__super__.constructor.apply(this, arguments);
      this.startViewStack = new StartViewStack();
      this.append(this.startViewStack);
      this.routes({
        '/employees/:id/add': function(params) {
          var data;
          return data = {
...
(function($) {
  $.template("app/views/pages/edit", "<form>\n  <label>\n    <span>Name<\/span>\n    <input type=\"text\" name=\"name\" value=\"${name}\" required autofocus>\n  <\/label>\n\n  <label>\n    <span>Body<\/span>\n    <textarea name=\"body\">${body}<\/textarea>\n  <\/label>\n  \n  <button>Save<\/button>\n<\/form>\n");
})(jQuery);
(function($) {
  $.template("app/views/pages/item", "<li class=\"item\">${name}<\/li>\n");
})(jQuery);
(function($) {
  $.template("app/views/pages/list", "<h1>Pages<\/h1>\n\n<ul class=\"items\"><\/ul>\n\n<a class=\"create\">Create Page<\/a>\n");
})(jQuery);
(function($) {
  $.template("app/views/pages/show", "<a class=\"back\">Back<\/a>\n<a class=\"edit\">Edit<\/a>\n<a class=\"destroy\">Delete<\/a>\n\n<p>Name: ${name}<\/p>\n\n<p>Body: ${body}<\/p>\n");
})(jQuery);
(function() {
  var App, MainController, Spine;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
