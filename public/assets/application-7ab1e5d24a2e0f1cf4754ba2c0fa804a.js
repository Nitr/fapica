...
(function() {
  ...
  $ = jQuery;
  Start = (function() {
    __extends(Start, Spine.Controller);
    function Start() {
      Start.__super__.constructor.apply(this, arguments);
      this.pages = new Pages;
      this.html($.tmpl('app/views/start/list'));
      new Spine.Manager(this.pages);
      this.append(this.pages);
      this.routes({
        '/pages': function(params) {
          return this.pages.active(params);
        }
      });
      this.navigate('/');
      Start.bind('refresh', function() {
        return Spine.Route.setup();
      });
      Start.fetch();
    }
...
(function($) {
  $.template("app/views/start/list", "<h1>Start<\/h1>\n\n<ul class=\"items\">asdad<\/ul>\n");
})(jQuery);
(function() {
